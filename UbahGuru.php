...
$guru = query("SELECT * FROM guru WHERE Kode_Guru = $kode")[0];
                                    ...
                                    <div class="col-md-6">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                <input type="hidden" name="id" value="<?= $guru["Kode_Guru"]; ?>">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Nama Lengkap" name="nama" value="<?= $guru["Nama"]; ?>" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="NIS" name="nip" value="<?= $guru["NIP"]; ?>" />
                                            </div>
