...
$org = query("SELECT * FROM organisasi WHERE id_org = $id")[0];
                                    ...
                                    <div class="col-md-6">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                <input type="hidden" name="id" value="<?= $org["id_org"]; ?>">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Nama Organisasi" name="nama" value="<?= $org["Nama"]; ?>" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Jumlah Anggota" name="jml" value="<?= $org["Jumlah_Anggota"]; ?>" />
                                            </div>
