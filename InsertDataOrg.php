                                    ...
                                    <div class="col-md-6">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Nama Organisasi" name="Nama" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Jumlah Anggota" name="jml" />
                                            </div>
                                            <button type="submit" class="btn-sm btn-success" name="submit">Tambah Data</button>
                                        </form>
